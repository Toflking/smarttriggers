...
public class TriggerRuleConfig {
    ...
    private List<TriggerActionConfig> actions = new ArrayList<>();


    public List<TriggerActionConfig> getActions() {
        return actions;
    }

    public void setActions(List<TriggerActionConfig> actions) {
